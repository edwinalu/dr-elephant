...
Stage 1: median task run time is 8.33 min.
Stage 1: please increase the number of partitions, which is currently set to 3.
Stage 2: median task run time is 10.00 min.
Stage 3: median task run time is 5.00 min.
Stage 5: median task run time is 16.67 min.
Stage 5: please increase the number of partitions, which is currently set to 10."""
      val expectedDetails = Map(
...
Stage 5: please increase the number of partitions, which is currently set to 10."""
    ...
    it("long tasks and execution memory spill 1") {
      ...
      val result = configurationParametersHeuristic.apply(data)
      val expectedStageDetails = "Stage 2: median task run time is 10.00 min.\n" +
    ...
    it("long tasks and execution memory spill 2") {
      ...
      val expectedStageDetails = "Stage 2 has 585.94 GB execution memory spill.\n" +
        "Stage 3: median task run time is 15.00 min.\n" +
    ...
    it("long tasks and execution memory spill 3") {
      ...
      val expectedStageDetails = "Stage 2 has 1.14 TB execution memory spill.\n" +
        "Stage 3: median task run time is 10.00 min.\n" +
        "Stage 3 has 1.17 GB execution memory spill."
      val expectedDetails = Map(
        "Current spark.executor.memory" -> "2GB",
        "Current spark.driver.memory" -> "2GB",
    ...
    it("execution memory spill 1") {
      ...
      val result = configurationParametersHeuristic.apply(data)
      val expectedStageDetails = "Stage 2 is processing a lot of data; examine the application to see if this can be reduced.\n" +
